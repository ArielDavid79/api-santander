 ...
 */
final class Version20250618010213 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE trasacao (id INT AUTO_INCREMENT NOT NULL, conta_origem_id INT NOT NULL, conta_destino_id INT NOT NULL, data_hora DATETIME NOT NULL, valor NUMERIC(12, 2) NOT NULL, INDEX IDX_23F504D1332BCA77 (conta_origem_id), INDEX IDX_23F504D188825F03 (conta_destino_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE trasacao ADD CONSTRAINT FK_23F504D1332BCA77 FOREIGN KEY (conta_origem_id) REFERENCES conta (id)
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE trasacao ADD CONSTRAINT FK_23F504D188825F03 FOREIGN KEY (conta_destino_id) REFERENCES conta (id)
        SQL);
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE trasacao DROP FOREIGN KEY FK_23F504D1332BCA77
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE trasacao DROP FOREIGN KEY FK_23F504D188825F03
        SQL);
        $this->addSql(<<<'SQL'
            DROP TABLE conta
        SQL);
